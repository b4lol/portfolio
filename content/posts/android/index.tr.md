...
Bu kılavuz, cihazı kullanürken güvenlik ve gizlilik arasında en iyi dengeyi sağlamak amacıyla hazırlanmıştır. Root yetkisi alma (rooting) ve önyükleyici (bootloader) kilidini açma gibi işlemler cihazın temel güvenlik mekanizmalarını zayıflattığı için önerilmemektedir.
