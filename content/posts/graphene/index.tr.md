...
## Ayarlar Üzerinden Sertleştirme {#hardening-attraverso-le-impostazioni}
...
## Önerilen Uygulamalar {#applicazioni}
...
### Yalıtılmış Google Play Hizmetleri
...
- **[Android'i Google Servislerinden Arındırma: Eksiksiz Gizlilik Kılavuzu](/tr/android)** - Google servislerinden arındırılmış herhangi bir Android telefon için tam yapılandırma
