...
## Donanım: Güvenli Bir Platform Seçimi {#hardware style="color: white;"}
...
## macOS Kurulumu ve Etkinleştirilmesi {#installazione style="color: white;"}
...
## İlk Açılış ve Hesap Kurulumu {#primo-avvio style="color: white;"}
...
## Standart Kullanıcı Hesabı Kullanımı {#account style="color: white;"}
...
## Önyükleme Güvenliği ve FileVault {#firmware-filevault style="color: white;"}
...
## Güvenlik Duvarı Sıkılaştırması {#firewall style="color: white;"}
...
## Servisler, Daemon'lar ve Paket Yönetimi {#servizi style="color: white;"}
...
### Paket Yöneticisi Güvenliği (Homebrew) {#homebrew style="color: white;"}
...
## DNS: Çözümlemenin Güvenliğini Sağlama {#dns style="color: white;"}
...
## Sertifika Güveni ve Tarayıcı Sıkılaştırma {#certificati style="color: white;"}
...
### Tarayıcı Seçimi ve Sıkılaştırma {#browser style="color: white;"}
...
## Anonimlik ve Aktarım Güvenliği (Tor ve VPN) {#tor style="color: white;"}
...
### VPN Servisleri {#vpn style="color: white;"}
...
## Kriptografik Araçlar ve Dosya Güvenliği {#pgp style="color: white;"}
...
### Güvenli Mesajlaşma İstemcileri {#messaggistica style="color: white;"}
...
## Kötü Amaçlı Yazılımlardan Korunma {#malware style="color: white;"}
...
## Meta Verileri ve Dijital İzleri Temizleme {#metadati style="color: white;"}
...
## Parolalar ve Çok Faktörlü Kimlik Doğrulama (MFA) {#password style="color: white;"}
...
## Yedekleme Stratejisi ve Yerel Ağ Güvenliği {#backup style="color: white;"}
...
### Yerel Wi-Fi Yapılandırması {#wifi style="color: white;"}
...
### SSH Bağlantılarını Sıkılaştırma {#ssh style="color: white;"}
...
## Fiziksel Güvenlik Önlemleri {#fisico style="color: white;"}
...
## Kurulum Sonrası Sertleştirme Ayarları {#varie style="color: white;"}
...
## Önerilen Güvenlik Yazılımları {#software style="color: white;"}
...
- **[Android'i Google Servislerinden Arındırma: Eksiksiz Gizlilik Kılavuzu](/tr/android)** - Aynı gizlilik ilkelerini Android telefonunuza da uygulayın
